...
class KardTests(KardTestCase):
    ...
    def test_state_changed(self):
        ...
        self.assertEqual(True, k.state_changing)
        k.save()
...
class ServiceClassRecordTests(KardboardTestCase):
    def setUp(self):
    ...
    def _fixtures_for_test_current(self):
    ...
    def test_current_struct(self):
        self._fixtures_for_test_current()
